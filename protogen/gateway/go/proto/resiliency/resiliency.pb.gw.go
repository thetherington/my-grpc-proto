...
func RegisterResiliencyWithMetadataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extResiliency.ResiliencyWithMetadataServiceServer) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/UnaryResiliencyMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/metadata/unary"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterResiliencyWithMetadataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extResiliency.ResiliencyWithMetadataServiceClient) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/UnaryResiliencyMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/metadata/unary"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/ServerStreamingResiliencyMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/metadata/server_streaming"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/ClientStreamingResiliencyMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/metadata/client_streaming"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/BiDirectionalResiliencyMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/metadata/bidirectional_streaming"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "resiliency", "v1", "metadata", "unary"}, ""))

	pattern_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "resiliency", "v1", "metadata", "server_streaming"}, ""))

	pattern_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "resiliency", "v1", "metadata", "client_streaming"}, ""))

	pattern_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "resiliency", "v1", "metadata", "bidirectional_streaming"}, ""))
)
