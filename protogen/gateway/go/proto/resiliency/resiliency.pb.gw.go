...
import (
	...
	extResiliency "github.com/thetherington/my-grpc-proto/protogen/go/resiliency"
...
func request_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0(ctx context.Context, marshaler runtime.Marshaler, client extResiliency.ResiliencyWithMetadataServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extResiliency.ResiliencyRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UnaryResiliencyMetadata(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0(ctx context.Context, marshaler runtime.Marshaler, server extResiliency.ResiliencyWithMetadataServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extResiliency.ResiliencyRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UnaryResiliencyMetadata(ctx, &protoReq)
	return msg, metadata, err

}

func request_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0(ctx context.Context, marshaler runtime.Marshaler, client extResiliency.ResiliencyWithMetadataServiceClient, req *http.Request, pathParams map[string]string) (extResiliency.ResiliencyWithMetadataService_ServerStreamingResiliencyMetadataClient, runtime.ServerMetadata, error) {
	var protoReq extResiliency.ResiliencyRequest
	var metadata runtime.ServerMetadata
	...
	stream, err := client.ServerStreamingResiliencyMetadata(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func request_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0(ctx context.Context, marshaler runtime.Marshaler, client extResiliency.ResiliencyWithMetadataServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
	stream, err := client.ClientStreamingResiliencyMetadata(ctx)
	if err != nil {
		grpclog.Infof("Failed to start streaming: %v", err)
		return nil, metadata, err
	}
...
func request_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0(ctx context.Context, marshaler runtime.Marshaler, client extResiliency.ResiliencyWithMetadataServiceClient, req *http.Request, pathParams map[string]string) (extResiliency.ResiliencyWithMetadataService_BiDirectionalResiliencyMetadataClient, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
	stream, err := client.BiDirectionalResiliencyMetadata(ctx)
	if err != nil {
		grpclog.Infof("Failed to start streaming: %v", err)
		return nil, metadata, err
	}
...
func RegisterResiliencyWithMetadataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extResiliency.ResiliencyWithMetadataServiceServer) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/UnaryResiliencyMetadata", runtime.WithHTTPPathPattern("/resiliency.ResiliencyWithMetadataService/UnaryResiliencyMetadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		err := status.Error(codes.Unimplemented, "streaming calls are not yet supported in the in-process transport")
		_, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		return
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		err := status.Error(codes.Unimplemented, "streaming calls are not yet supported in the in-process transport")
		_, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		return
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		err := status.Error(codes.Unimplemented, "streaming calls are not yet supported in the in-process transport")
		_, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		return
...
func RegisterResiliencyWithMetadataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extResiliency.ResiliencyWithMetadataServiceClient) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/UnaryResiliencyMetadata", runtime.WithHTTPPathPattern("/resiliency.ResiliencyWithMetadataService/UnaryResiliencyMetadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/ServerStreamingResiliencyMetadata", runtime.WithHTTPPathPattern("/resiliency.ResiliencyWithMetadataService/ServerStreamingResiliencyMetadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/ClientStreamingResiliencyMetadata", runtime.WithHTTPPathPattern("/resiliency.ResiliencyWithMetadataService/ClientStreamingResiliencyMetadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/BiDirectionalResiliencyMetadata", runtime.WithHTTPPathPattern("/resiliency.ResiliencyWithMetadataService/BiDirectionalResiliencyMetadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"resiliency.ResiliencyWithMetadataService", "UnaryResiliencyMetadata"}, ""))

	pattern_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"resiliency.ResiliencyWithMetadataService", "ServerStreamingResiliencyMetadata"}, ""))

	pattern_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"resiliency.ResiliencyWithMetadataService", "ClientStreamingResiliencyMetadata"}, ""))

	pattern_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"resiliency.ResiliencyWithMetadataService", "BiDirectionalResiliencyMetadata"}, ""))
)

var (
	forward_ResiliencyWithMetadataService_UnaryResiliencyMetadata_0 = runtime.ForwardResponseMessage

	forward_ResiliencyWithMetadataService_ServerStreamingResiliencyMetadata_0 = runtime.ForwardResponseStream

	forward_ResiliencyWithMetadataService_ClientStreamingResiliencyMetadata_0 = runtime.ForwardResponseMessage

	forward_ResiliencyWithMetadataService_BiDirectionalResiliencyMetadata_0 = runtime.ForwardResponseStream
)
